         ...
         <div className="flex-1 flex overflow-hidden">
            <aside className="w-72 bg-white border-r border-gray-100 flex flex-col z-[1050]">
               ...
               <div className="p-6 bg-gray-50/50 border-t border-gray-100 space-y-2">
                                    \u003cbutton onClick={onSignOut} className=\"w-full bg-red-500/10 text-red-600 border border-red-200 font-black uppercase tracking-widest py-4 rounded-2xl text-[11px] flex items-center justify-center gap-3 hover:bg-red-500 hover:text-white transition-all shadow-sm\"\u003e\u003cLogOut size={16} /\u003e Sign Out\u003c/button\u003e
