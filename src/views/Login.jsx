  ...
  return (
    <div className="min-h-screen bg-[var(--bg)] flex items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="w-full max-w-[480px] z-10">
        {onBack && (
          <button onClick={onBack} className="flex items-center gap-2 text-[11px] font-black uppercase tracking-widest text-gray-400 hover:text-[var(--brand-primary)] transition-colors mb-6">
            ← Back to Hub
          </button>
        )}
          ...
          <form onSubmit={handleSubmit} className="w-full space-y-6">
            ...
            <button type="submit" disabled={loading}
              ...
              {loading
                ...
                : <><span>Connect to Ledger</span><ArrowRight size={18} /></>
              }
            </button>
          </form>
