  ...
  return (
    <div className="p-10 space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-500 overflow-y-auto h-full bg-gray-50/50">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        <MetricTile label="Carbon Stock" value="128k" unit="tCO2e" color="bg-amber-900" icon={<Leaf size={24} />} />
        <MetricTile label="Shade Trees" value="12.4" unit="k" color="bg-amber-900" icon={<Trees size={24} />} />
        <MetricTile label="Traceability" value="100" unit="%" color="bg-amber-900" icon={<Activity size={24} />} />
        <MetricTile label="Compliance" value="100" unit="%" color="bg-emerald-500" icon={<CheckCircle2 size={24} />} />
      </div>
      <div className="flex flex-col lg:flex-row gap-8">
        <div className="lg:w-2/3 space-y-8">
           <SimpleCard title="Carbon Project Monitoring" icon={<Globe size={20} />}>
              <div className="h-[400px] relative rounded-2xl overflow-hidden border border-gray-100">
                 <GeospatialPreview title="Cocoa Carbon Layer" points={[]} full={true} />
              </div>
           </SimpleCard>
        </div>
