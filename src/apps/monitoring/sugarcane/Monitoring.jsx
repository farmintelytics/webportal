...
const CONFIG = {
   primaryColor: 'purple',
   theme: 'Industrial / Biomass Focused',
   indices: [
      { id: 'NDRE', label: 'Chlorophyll (NDRE)', legend: 'Low - High', color: 'from-gray-100 to-teal-600', active: true, opacity: 80 },
      { id: 'NDVI', label: 'Biomass (NDVI)', legend: 'Sparse - Dense', color: 'from-amber-50 to-emerald-900', active: false, opacity: 80 },
      { id: 'LSWI', label: 'Moisture (LSWI)', legend: 'Dry - Moist', color: 'from-stone-200 to-sky-600', active: false, opacity: 60 },
   ],
   kpis: [
      { label: 'Cane Density', value: 'OPTIMAL', unit: 'INDEX', icon: <Activity /> },
      { label: 'Sugar Potential', value: '0.72', unit: 'NDRE', icon: <Zap /> },
      { label: 'Water Status', value: 'GOOD', unit: 'LSWI', icon: <Droplets /> },
   ],
   layman: {
      health: 'Biomass accumulation is optimal for the current ratoon stage.',
      stress: 'Moisture stress detected in northwestern blocks.',
      yield: 'Predicted tonnage is 84.2 MT/ha based on current NDRE.'
   },
   drillDownType: 'Biomass Anomaly'
};

const SugarcaneMonitoring = ({ onBack }) => {
   ...
   const plots = [
      { id: `B-SUG-01`, area: '4.2 HA', health: '98%', status: 'Healthy', ndvi: 0.72, layman: CONFIG.layman.health, advice: 'No action needed.', history: [0.3, 0.45, 0.58, 0.72, 0.75, 0.72] },
      { id: `B-SUG-04`, area: '2.8 HA', health: '35%', status: 'Stressed', ndvi: 0.35, layman: CONFIG.layman.stress, advice: 'Inspect and apply remediation.', history: [0.3, 0.32, 0.40, 0.38, 0.35, 0.33] },
   ];
                  ...
                  <div className="h-16 bg-white border-b border-gray-100 flex items-center justify-between px-8 z-[1010]">
                     <div className="flex items-center gap-6 flex-1 max-w-4xl">
                        <div className="relative flex-1">
                           ...
                           <input type="text" placeholder="Locate Sugarcane Plot..." className="w-full bg-gray-50 border border-gray-100 rounded-xl py-2.5 pl-12 pr-4 text-[12px] font-bold outline-none focus:border-emerald-500 transition-all" />
                        </div>
                     </div>
            ...
            return (
               <div className="p-10 space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500 overflow-y-auto h-full bg-gray-50/50">
                  <div className="flex flex-col lg:flex-row justify-between lg:items-end gap-6">
                     <div>
                        <h2 className="text-3xl font-black text-gray-900 tracking-tighter italic uppercase">Sugarcane Analytical Ledger</h2>
            ...
            return (
               <div className="p-10 space-y-10 animate-in fade-in duration-500 overflow-y-auto h-full bg-gray-50/50">
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                     <SimpleCard title="Sugarcane Growth Trajectory" icon={<TrendingUp size={20} />}>
      ...
      <div className="h-screen flex flex-col bg-gray-50 text-gray-900 overflow-hidden font-sans antialiased">
         <header className="h-20 bg-white border-b border-gray-100 flex items-center justify-between px-10 z-[1100] shadow-sm">
            <div className="flex items-center gap-8">
               ...
               <div>
                  <h1 className="text-lg font-black tracking-tighter leading-none uppercase italic">Sugarcane <span className="text-gray-400 font-medium ml-1">Monitoring & RS</span></h1>
...
export default SugarcaneMonitoring;
