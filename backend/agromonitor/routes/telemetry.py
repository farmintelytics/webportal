...
def get_plots_telemetry(request, date: Optional[str] = None, plot_id: Optional[str] = None):
    ...
    - Cumulative Rainfall (mm)             → rainfall_mm
    - Soil Temperature (celsius)           → soil_temp_celsius
    - Land Surface Temperature / LST (°C)  → surface_lst_celsius
    - Vapor Pressure Deficit / VPD (kPa)  → vpd_kpa
    ...
    # Mock microclimate telemetry profiles per plot
    telemetry_profiles = {
