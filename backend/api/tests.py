...
class ApiEndpointsTestCase(TestCase):
    ...
    def test_alerts(self):
        ...
        # Acknowledge ALT-001
        response_ack = self.client.post('/api/alerts/ALT-001/acknowledge')
        self.assertEqual(response_ack.status_code, 200)
        self.assertEqual(response_ack.json()["status"], "success")

    def test_verification(self):
        response = self.client.get('/api/verification/audit?plot_id=PLOT-ALPHA')
        self.assertEqual(response.status_code, 200)
    ...
    def test_reports(self):
        ...
        # Reports list
        response_list = self.client.get('/api/reports/list')
